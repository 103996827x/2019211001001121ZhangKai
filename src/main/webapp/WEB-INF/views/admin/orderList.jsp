        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.zhangkai.model.Order o = (com.zhangkai.model.Order) pageContext.findAttribute("o");
                        int userId = o.getCustomerId();
                        java.sql.Connection con = (java.sql.Connection) application.getAttribute("dbConn");
                        com.zhangkai.dao.UserDao userDao = new com.zhangkai.dao.UserDao();
                    ...
                    <td class="cart_total">${o.paymentId}
                        <%
                            ...
                            String paymentType = com.zhangkai.model.Payment.findByPaymentId(con, n);
                        %>
