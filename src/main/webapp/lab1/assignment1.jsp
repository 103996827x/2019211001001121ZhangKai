...
<ul>
    <c:forEach var="c" begin="1" end="9" step="2">
        <li>${c}</li>
    </c:forEach>
</ul>
...
<ul>
    <c:forEach var="c" begin="2" end="10" step="2">
        <li>${c}</li>
    </c:forEach>
</ul>
...
<ul>
    <c:forEach var="c" begin="0" end="9" step="2">
        <li>${words[c]}</li>
    </c:forEach>
</ul>
...
<%
    ...
    personList.add(new Person("Alen", new Dog("Amy")));
...
<ul>
    <c:forEach var="c" begin="0" end="2">
        <li>${AllPerson.get(c).name } : ${AllPerson.get(c).dog.name}</li>
    </c:forEach>
</ul>
